...
<body class="men">
    ...
    <h1><span style="color: white;">Men's Section</span></h1>
    <div class="shoescontainer">
        ...
        <div class="card">
            ...
            <button onclick="purchaseItem('men-shoe<?php echo $count; ?>', '', <?php echo $row['price']; ?>, '<?php echo $row['image']; ?>')">Purchase</button>
        </div>
        <?php
                }
            } 
