...
<body class="index4">
   <nav>
    ...
    <h1><span style="color: white;">Kids Section</span></h1>
    <div class="shoescontainer">
       <?php
        ...
        <div class="card">
            ...
            <button onclick="purchaseItem('kids-shoe<?php echo $count; ?>', '', <?php echo $row['price']; ?>, '<?php echo $row['image']; ?>')">Purchase</button>
        </div>
        <?php
                }
            } 
